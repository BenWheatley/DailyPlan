...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Scott Manley ("Watching a Wildfire Big Enough To Make Its Own Weather - Park Fire, 2024, California"); Plasma Channel ("This High Voltage Fog Is Controlled by Pointing (BiFrost Nebulagraphy)"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Post signed minutes
- [x] Continue ShisenSho2024 (JavaScript project)
- [x] Weights: 10 kg, 20 reps each arm, 1 position

Friday 2 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Crash Course Pods: The Universe (8); PBS Space Time ("Colored Black Holes Explained"); Two Minute Papers ("Wow, World-Class AI For Free, For Everyone!"); Primitive Technology ("Water Bellows (uses water instead of leather)"); Not What You Think ("Why Russians Think X-37 is a Nuclear Space Bomber"); Rocking German Grammar ("Wohin fahren wir? - nach, zu, in, an, auf (B1)"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 5
- [x] Vaccination
- [x] Continue ShisenSho2024 (JavaScript project)
...
- [x] Next podcast or continue audio book (Not What You Think ("Why the US is NOT afraid of the largest Navy in the world, yet"); Stand-up Maths ("The Greenwich Meridian is in the wrong place"); Answer in Progress ("why you were forced to learn the recorder in school"); Scott Manley ("SpaceX Returns To Flight - Deep Space Updates - August 2nd - Scotland Edition!"); Infinimata ('"Gödel, Escher, Bach": Minds, Machines, And Math'); Looking Glass Universe ("I built a GPT model in 10 hours"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Sunday 4 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Two Minute Papers ("OpenAI’s New AI: Being Smart Is Overrated!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 6
- [x] Begin making Mahjong2024 (JavaScript project)

Monday 5 August

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Two Minute Papers ("OpenAI’s DALL-E 3-Like AI For Free, Forever!"); Scott Manley ("Sputnik 3 - The First Soviet Satellite That Didn’t Suck"); Science with Sabine ("The Trouble with Heat Pumps -- and other science news of the week", "Fossil Fuels Don't Come From Fossils? Tucker Carlson Fact Check - and other science news of the week"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (9))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3
- [x] Install and play around with OpenSCAD
- [x] Make payment for house fees

Tuesday 6 August

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); The TWIML Al Podcast ("How Microsoft Scales Testing and Safety for Generative Al with Sarah Bird", "Bridging the Sim2real Gap in Robotics with Marius Memmel"); Coffee Break German (s1e22))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 2
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Coffee Break German (s1e23))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); The Thought Emporium ("Turning Film Negatives Into Hologram Projectors"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Friday 9 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); This Old Tony ("The Secret Life Of Gas Springs"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Improve Mahjong web game

Saturday 10 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Real Engineering ("Revolutionizing the Logistics of Spaceflight - Firefly Aerospace"); Scott Manley ("Will Astronaut's 8 Day Mission Turn into an 8 Month Mission? Starliner Answers Slowly Emerge."))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Improve Mahjong web game
- [x] Write blog post
...
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Overly Sarcastic Productions ("Miscellaneous Myths: Cadmus"); History Matters ("Did the USA and USSR always hate each other? (Short Animated Documentary)"); Stand-up Maths ("Search for the mythological Klein-ing Frame"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 4
- [x] Continue learning to use OpenSCAD
- [x] Gather documents for German tax agent

Monday 12 August

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (380))
- [x] “Clozemaster” German lessons: >2000 XP
- [x] Babbel German lessons: 3
- [x] Proof-read tax documents, then send to German tax agent

Tuesday 13 August

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Coffee Break German (s1e25); The TWIML Al Podcast ("Building Real-World LLM Products with Fine-Tuning and More with Hamel Husain" first half))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); The TWIML Al Podcast ("Building Real-World LLM Products with Fine-Tuning and More with Hamel Husain" second half); Science with Sabine ("Musk Promises Superhuman Vision, Experts Say It's Nonsense"))
- [x] “Clozemaster” German lessons: >2000 XP
- [x] Babbel German lessons: 3

Thursday 15 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Tech Ingredients ("Air Conditioning isn't free... but we're close.", "Revolutionary Paint: How to Make Surfaces Stay Cool in the Sun", "COULD SATELLITE LASERS REALLY DO THIS?..."); NightHawkInLight ("Making Infrared Cooling Paint From Grocery Store Items (w/Novel CaCO₃ Microsphere Synthesis)", "DIY Cooling Fibers Successfully Made!"); PBS Space Time ("Can We Create New Elements Beyond the Periodic Table?"); Science with Sabine ("Faster than Light Particles Could Exist After All"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Email Notar
- [x] Dentist
...
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); NightHawkInLight ("Making Opals for Free Air Conditioning"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3

Saturday 17 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Veritasium ("These Illusions Fool Almost Everyone"); Two Minute Papers ("NVIDIA’s New AI Will Supercharge Gaming!"); Stand-up Maths ("The search for the biggest shape in the universe."); The Royal Institution ("The earth as a planet - Carl Sagan's 1977 Christmas Lectures 1/6"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Sunday 18 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Overly Sarcastic Productions ("History-Makers: Thomas Cole", "History Hijinks: Roman Wise Guys", "Trope Talk: Last Of Their Kind");  Journey to the Microcosmos ("What These Microbes Teach Us About Free Will"); The Tim Traveller ("The 1900 Paris Olympics Were Pure Glorious Chaos"); Practical Construction ("Installing a Water Main Below Railroad Tracks"))
- [x] “Clozemaster” German lessons: >2500 XP
- [x] Babbel German lessons: 3
- [x] Book updated ID card

Monday 19 August

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Crash Course Pods: The Universe (9); Scott Manley ("How The V-2 Rocket Launched America's Space Race"); Rare Earth ("Is This Ancient History's Most Important Resource?"))
- [x] “Clozemaster” German lessons: >3000 XP
- [x] Babbel German lessons: 3
...
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3
- [x] Check, sign, and send tax return
- [x] Print and sign document for M
- [x] Reply to message from Bürgerämter

Wednesday 21 August

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Science with Sabine ("Are childless people a problem? -- and other science news of the week"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 2
- [x] Post document for M

Thursday 22 August

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Two Minute Papers ("New AI Makes The Mona Lisa Come Alive!"); The Royal Institution ("The outer solar system and life - Carl Sagan's 1977 Christmas Lectures 2/6"); Future of Life Institute Podcast ("Samuel Hammond on why Al Progress is Accelerating - and how Governments Should Respond"))
- [x] “Clozemaster” German lessons: >1000 XP

Friday 23 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); PBS Space Time ("Is Gravity RANDOM Not Quantum?"); Medlife Crisis 2 ("Biology’s dark matter moment (that never happened)"); Stand-up Maths ("The Bingo Paradox: 3× more likely to win"); Trope Talk: Urban Fantasy ("Overly Sarcastic Productions"); Dr. Becky ("JWST has turned the Crisis in Cosmology into a bigger problem | Night Sky News August 2024"); History Matters ("Did Rome know about Scandinavia and the Vikings?"); The TWIML Al Podcast ("Accelerating Sustainability with Al with Andres Ravinet"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 7

Saturday 24 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Scott Manley ("SpaceX Astronauts Will Fly Higher Than Any Human Has This Century"); Two Minute Papers ("OpenAI's ChatGPT Does Research… And Breaks Itself!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Investigative trip to shop for white goods for new home

Sunday 25 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); TenTen ("How a Klystron amplifier works"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3
- [x] Sign bank form
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (4 items); The TWIML Al Podcast ("The Building Blocks of Agentic Systems with Harrison Chase"); Two Minute Papers ("DeepMind’s New AI Looked At 100,000,000 Examples!"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3
- [x] Send money to bank

Tuesday 27 August

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Science with Sabine ("Will This Crazy Idea Make Mars Habitable? -- and other science news of the week"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (402))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Stand-up Maths ("We shot a YouTube video about film formats on 35mm film"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Two Minute Papers ("Crazy New AI Learned To Rewrite Doom!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Take photo of degree certificate for R

Friday 30 August

- [x] Next podcast or continue audio book (Scott Manley ("Why Did SpaceX's Oldest Booster Crash Land? - Was it Engines? Radar? Big Waves?"); Crash Course Pods: The Universe (10))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Begin project to experiment with flex/lex/yacc/bison etc.

Saturday 31 August

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); S3 ("They Built This Robot For Your Home | 1X Technologies"); Jay Foreman ("How bad maps win elections - Gerrymandering explained"); Rare Earth ("History of Lebanon Part One: The Phoenicians"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Take bag of junk to municipal waste disposal

Sunday 1 September

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Stand-up Maths ("Are accurate election predictions luck or skill?"); Two Minute Papers ("NVIDIA’s Tech: Finally, Real Time Ray Tracing! (Episode 900 Special!)"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Email Re Finanzamt P
- [x] Send copy of C for R
- [x] Pack more

Monday 2 September

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (10))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Pack more
- [x] Email Re Finanzamt K

Tuesday 3 September

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (401))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Scott Manley ("Pilot Training Didn't Prepare Me To Handle This Situation"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (398 first half))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (5 items); Tom Stanton ("Electromagnetic Coil Launcher"); Plasma Channel ("Creating Plasma Shockwaves Using A Wireless Energy Tower (ft. Geerling Engineering)"); The Royal Institution ("Mars before Viking - Carl Sagan's 1977 Christmas Lectures 4/6"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3
- [x] Pre-move move
...
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Ikea visit, set up garden table and chair

Saturday 7 September

- [x] Next podcast or continue audio book (The TWIML Al Podcast ("Genie: Generative Interactive Environments with Ashley Edwards"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (398 second half))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Hellweg
- [x] Clean/weed driveway
- [x] Clean terrace

Sunday 8 September

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item);  Two Minute Papers ("DeepMind AlphaProteo AI: A Gift To Humanity! 🧬"); 3Blue1Brown ("How might LLMs store facts | Chapter 7, Deep Learning"); Integza ("I Built The First LAMINAR FLOW ROCKET ENGINE"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (389); Science with Sabine ("Core Meltdown Emergency Test At Chinese Nuclear Reactor -- and other science news of the week"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 5
- [x] Order more items for move
- [x] Pack more
- [x] Take more to new place
- [x] Take more things to new place
...
- [x] Babbel German lessons: 3
- [x] Clean new kitchen
- [x] Unblock terrace drains
- [x] Read manual for intercom

Tuesday 10 September

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (4 items); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (407); Deutsche im Alltag - Alltagsdeutsch | Audios | DW Deutsch lernen (1 item); Not What You Think ('America's “Aircraft Carrier Shortage” Explained'); Two Minute Papers ("OpenAI Sora: Alternatives To Try Right Now!"); Primitive Technology ("Water Bellows smelt"); Scott Manley ("Does It Make Sense To Put Data Centers In Space? Can They Really Cost Less To Operate?"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3
- [x] Buy more stuff for new place
- [x] Continue cleanup of old place
- [x] Get quotes: 3
- [x] Pack more
- [x] Fill out form for M

Wednesday 11 September

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (5 items))
- [x] “Clozemaster” German lessons: >2000 XP
- [x] Babbel German lessons: 6
- [x] Post letter for M
- [x] Meet R
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Two Minute Papers ("OpenAI’s ChatGPT Is Now Learning From Another AI!"); Stand-up Maths ("The unexpected probability result confusing everyone"); The Thought Emporium ("Making A True Potato Camera" to 11:05))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 10
- [x] Pack more
- [x] Continue cleanup of old place
- [x] Umzug provider quote
- [x] Pay bills on desk: €100, €585 (put on sheet)
...
- [x] LWCW
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Science with Sabine ("Nuclear Fusion Predictions are Nonsense -- and other science news of the week"); Coffee Break German (s1e24); Crash Course Pods: The Universe (11))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 6
...
- [x] LWCW
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (4 items))
- [x] “Clozemaster” German lessons: >3500 XP
- [x] Babbel German lessons: 6
...
- [x] LWCW
- [x] Next podcast or continue audio book (Top-Thema mit Vokabeln | Audios | DW Deutsch lernen (3 items); The TWIML Al Podcast ("Automated Design of Agentic Systems with Shengran Hu"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (409); Two Minute Papers ("OpenAl 01: ChatGPT Supercharged!"); The Thought Emporium ("Making A True Potato Camera" first half))
- [x] “Clozemaster” German lessons: >6000 XP
- [x] Babbel German lessons: 12
- [x] Pack more
- [x] Continue cleanup of old place
- [x] Recycle glass
- [x] Buy plumber's drain auger
- [x] Walk 16.0 km

Tuesday 17 September

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (8 items); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (403); Coffee Break German (s1e28, s2e01); Science with Sabine ("This New Idea to Detect a Quantum of Gravity Might Just Work -- and other science news of the week"))
- [x] “Clozemaster” German lessons: >3500 XP
- [x] Babbel German lessons: 16

Wednesday 18 September

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (2 items); The TWIML Al Podcast ("Supercharging Developer Productivity with ChatGPT and Claude with Simon Willison"); Scott Manley ("Is Testing A New Space Suit in Space The Ultimate Thrill?"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 7
- [x] Pack more
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Two Minute Papers ("NVIDIA's New Al Is Really Good At Moving Rabbits!"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 3
- [x] Receive and begin to unpack Umzug

Friday 20 September

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (11 first half))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Saturday 21 September

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (5 items); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (11 second half))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Sunday 22 September

- [x] Next podcast or continue audio book (PBS Space Time ("What If Gravity Isn't Quantum? New Experiments Explore"); The Thought Emporium ("Making A True Potato Camera" last half))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Coffee Break German (s1e01, s1e02, s1e03, s1e04, s1e05, s1e06, s1e07, s1e08, s1e09, s1e10))
- [x] “Clozemaster” German lessons: >1500 XP
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Coffee Break German (s1e11, s1e12, s1e13, s1e14, s1e15, s1e16, s1e17, s1e18, s1e19, s1e20); Scott Manley ("Wreckage Of Titan Submersible Reveal How It Imploded"))
- [x] “Clozemaster” German lessons: >1500 XP
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Coffee Break German (s1e21, s1e26, s1e27, s1e29); Two Minute Papers ("NVIDIA's Tech: Impossible Water Simulation!"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 4
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Coffee Break German (s1e30, s1e31, s1e32))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 10

Friday 27 September

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Coffee Break German (s1e33, s1e34, s1e35); Science with Sabine ("No, Einstein Didn't Solve the Biggest Problem in Physics -- and other science news of the week"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Continue clear-out of old flat
- [x] Top-up phone credit
- [x] Gardening — clear as much of the weeds as possible before rain

Saturday 28 September

- [x] Next podcast or continue audio book (Coffee Break German (magazine s2e02); Two Minute Papers ("OpenAl's New ChatGPT: 7 Incredible Capabilities!", "NVIDIA's New Al: The King Is Here!"); Brainiac75 ('LASER Hair Blaster | How strong is this "Class 1" laser?!?'); PBS Space Time ("What If The Universe DID NOT Start With The Big Bang?", "The NEW PHYSICS of Black Hole Star Capture | Extreme Tidal Disruption Events"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 29
- [x] Explore Köpenick
...
- [x] Next podcast or continue audio book (Stand-up Maths ("How can a jigsaw have two distinct solutions?"); Overly Sarcastic Productions ("Trope Talk: Precursors", "History Summarized: Why Is English Such A Mess?", "History Summarized: The Tragedy of Classical Greece"); History Matters ("Why didn't India rebel during WW1 or WW2?", "Why didn't anyone revive the Holy Roman Empire?"); Dr Barker ("Can A Function Be Continuous At Only One Point?"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (4 items); Coffee Break German (magazine s2e03, magazine s2e04, magazine s2e05, s2e06); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (12); The TWIML Al Podcast ("Gen Al at the Edge: Qualcomm Al Research at CVPR 2024 with Fatih Porikli"))
- [x] “Clozemaster” German lessons: >3000 XP
- [x] Babbel German lessons: 21
- [x] Continue clear-out of old flat
- [x] Begin updating addresses

Tuesday 1 October

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (2 items); Coffee Break German (s1e36, s1e37, s1e38, s1e39, s1e40, s2e03, s2e04, s2e05, magazine s2e06, s2e07); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (12); The TWIML Al Podcast ("Gen Al at the Edge: Qualcomm Al Research at CVPR 2024 with Fatih Porikli"); Scott Manley ("Monster Booster Raised From Deep Sea By SpaceX - Deep Space Updates September 25th", "OceanGate Wreck Shows Why Sub Wasn't Strong Enough To Survive - NTSB Shares Important Details"); Science with Sabine ("This Lawsuit Could Change Science -- and other science news of the week"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 21
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Scott Manley ("Will This Experimental Supersonic Aircraft Show Supersonic Airliners Can Work?"); Two Minute Papers ("OpenAI’s New ChatGPT In 3 Minutes! + NotebookML and AlphaChip"); Up and Atom ("We Were Wrong About The Shape Of The Universe"); Coffee Break German (magazine s2e07, s2e08, magazine s2e08); The TWIML Al Podcast ("Simplifying On-Device Al for Developers with Siddhika Nevrekar"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 7

Thursday 3 October

- [x] Next podcast or continue audio book (Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (13))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 4
- [x] Continue clearing weeds from garden

Friday 4 October

- [x] Next podcast or continue audio book (Primitive Technology ("A-frame Roof Tile Factory"); Veritasium ("How do QR codes work? (I built one myself to find out)"); Two Minute Papers ("Unreal Engine 5.5 Is Here - Mega Greatness!"); ElectroBOOM ("SKIN EFFECT! Why Current Doesn't Run Inside"); The TWIML Al Podcast ("Al Agents for Data Analysis with Shreya Shankar"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (14))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 7
- [x] Continue clearing weeds from garden
...
- [x] Next podcast or continue audio book (Veritasium ("People said this experiment was impossible, so I tried it"); Das sagt man so! | Audios | DW Deutsch lernen (2 items))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 66
- [x] Continue clear-out of old flat

Sunday 6 October

- [x] Next podcast or continue audio book (3Blue1Brown ("How are holograms possible? | Optics puzzles 5"); Real Engineering ("The Problems with China's Space Program"); History Matters ("Why did Scotland and England unite?"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (15 first half))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 21
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (The TWIML Al Podcast ("Are LLMs Good at Causal Reasoning? with Robert Osazuwa Ness"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (15 second half))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 21
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Coffee Break German (s2e09, magazine s2e09); The TWIML Al Podcast ("The EU Al Act and Mitigating Bias in Automated Decisioning with Peter van der Putten"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (16))
- [x] “Clozemaster” German lessons: >2500 XP
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Scott Manley ("Can A Giant Potato Cannon Throw Things Into Space Cheaper Than Rockets? Longshot Think so!"); Two Minute Papers ("NVIDIA's Al: Gaming In A Minecraft World!"); Coffee Break German (s2e10, magazine s2e10); Science with Sabine ("These physicists say they know what's inside a black hole -- and other science news of the week"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (17, 18)
- [x] “Clozemaster” German lessons: >3000 XP
- [x] Babbel German lessons: 42

Thursday 10 October

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Two Minute Papers ("ChatGPT Gaming, 10,000,000 Particle Simulation, Al Nobel Prize!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 13

Friday 11 October

- [x] Next podcast or continue audio book (Tod's Workshop ("Rocket Powered Medieval arrows vs Armour!"); Coffee Break German (s2e11); The TWIML Al Podcast ("Pushing Back on Al Hype with Alex Hanna", "Al Agents: Substance or Snake Oil with Arvind Narayanan"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (19))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Continue clearing weeds from garden
...
- [x] Next podcast or continue audio book (Scott Manley ("How Did The Vulcan Rocket Survive This Booster Failure?"); Veritasium ("NASA's Search For Life in a Radiation Death Zone | Europa Clipper"); PBS Space Time ("What If The Cosmological Constant Is NOT Constant?"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (20, 31, 32, 33, 34, 35, 36, 37, 38, 39))
- [x] “Clozemaster” German lessons: >1000 XP
...
- [x] Next podcast or continue audio book (Sixty Symbols ("Where are the White Holes?"); BrainCraft ("The Formula to Stop Feeling Tired"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (21, 22, 23))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 7
- [x] Walk 8.8 km
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (3 items); Plasma Channel ("Custom Transformer Shatters All Voltage Records (ft. 3D Printing Nerd)"); Overly Sarcastic Productions ("History Summarized: Gilding the Nile"); Coffee Break German (s2e12))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 8
- [x] Respond to estate agent
- [x] Respond to E.ON
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Der Assecor IT-Podcast (13, 14); The TWIML Al Podcast ("Mojo: A Supercharged Python for Al with Chris Lattner - #634", "Modeling Human Behavior with Generative Agents with Joon Sung Park"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 13
- [x] Respond to estate agent
- [x] Respond to E.ON
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Two Minute Papers ("5 Almost Impossible Experiments…Until Now!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 6
- [x] Respond to estate agent
- [x] Respond to E.ON
- [x] Prepare package for ID card renewal process

Thursday 17 October

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (24))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 6
- [x] Appointment for ID card renewal

Friday 18 October

- [x] Next podcast or continue audio book (PBS Space Time ("Do Neutron Stars Shine In Dark Matter?"); History Matters ("Why did the Soviet Calendar fail?"); The Royal Institution ("The history of Mars - Carl Sagan's 1977 Christmas Lectures 3/6"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Continue clearing weeds from garden
- [x] Assemble composting box
- [x] Respond to E.ON
- [x] Respond to estate agent
- [x] Create Allianz e-account

Saturday 19 October

- [x] Next podcast or continue audio book (World Anvil Worldbuilding ("What is the Tiffany Problem in Worldbuilding?"); Continuous Delivery ("5 Things That Waste Time & Money On A Software Project"); Scott Manley ("Designing Rockets, Guns, Lasers and Nuclear Devices Using Physics"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern ("Zwischending: Wir podcasten jetzt häufiger"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 11
- [x] Ask for lawyer recommendation
- [x] Continue clearing weeds from garden
- [x] Visit S

Sunday 20 October

- [x] Next podcast or continue audio book (Scott Manley ("How SpaceX Landed A Rocket... Without Landing Legs. Catching a Giant Rocket With Giant Chopsticks"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 4
- [x] Inform estate agent of my new address
- [x] Inform estate management of my new address
- [x] Fill out form to inform land registry of my new address
- [x] Inform R of my new address
- [x] Inform T of my new address
- [x] Inform N of my new address
- [x] Inform C of my new address
- [x] Inform health insurance of my new address
- [x] Inform liability insurance of my new address

Monday 21 October

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Coffee Break German (s2e13); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern ("Zwischending: Dehnen, Yoga und Pilatus"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 12
- [x] Inform H of my new address
- [x] Inform P of my new address
- [x] Inform employer of my new address
- [x] Post to UK form to inform land registry of my new address
- [x] Inform UK accountant of my new address

Tuesday 22 October

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Coffee Break German (s2e14))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Quick response to information request

Wednesday 23 October

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Scott Manley ("How A Victorian Era Engine Made Spaceflight Possible... Let's Look At A 125 Year Old Turbine!"); styropyro ("I built a 20,000 watt microwave oven!"); Adam Savage’s Tested ("Testing the Limits of Delivery Drones! (with @theslowmoguys)"); The TWIML Al Podcast ("Stealing Part of a Production Language Model with Nicholas Carlini"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 14
- [x] Sort out S password, delete photo avatar
...
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Finish drafting and send email to E.ON

Friday 25 October

- [x] Next podcast or continue audio book (Scott Manley ("SpaceX Ditched an Entire Falcon Heavy To Launch NASA's Massive Probe To Europa!"); The TWIML Al Podcast ("Is Artificial Superintelligence Imminent? with Tim Rocktäschel"); Coffee Break German (s2e15, s2e16))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 11
- [x] Final clearance of old flat, hand over keys
- [x] Continue clearing weeds from garden
- [x] Walk 10.7 km

Saturday 26 October

- [x] Next podcast or continue audio book (Two Minute Papers ("OpenAI’s New AI Model: 50x Faster!", "The Future of AI Might Be…", "NVIDIA’s AI Looks At 4,000,000 Frames, Learns To Walk!"); Explosions&Fire ("making chlorine trifluoride…"); Stand-up Maths ("What do we know about Asteroid 314159 aka ‘Mattparker’?"); Overly Sarcastic Productions ("Pope Fights: The Pornocracy – Yes it's really called that"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Continue clearing weeds from garden
- [x] Begin grading garden soil

Sunday 27 October

- [x] Next podcast or continue audio book (Stand-up Maths ("New largest prime number found! See all 41,024,320 digits."); The Royal Institution ("Mars after Viking - Carl Sagan's 1977 Christmas Lectures 5/6"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern ("Zwischending: Virtuelle Geburtstagsparty"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 11
- [x] Finish grading garden soil
- [x] Sow grass seeds
- [x] Order more grass seeds
- [x] House insurance payment

Monday 28 October

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern ("Zwischending: Merkel kauft (W)ein", "Zwischending: Die Deutschen vertrauen der Politik"); Science with Sabine ("The Quantum Computing Collapse Has Begun -- and other science news of the week", "Surprise Comeback: Dark Energy Could Be Holographic After All -- and other science news of the week"))
- [x] “Clozemaster” German lessons: >2000 XP
- [x] Babbel German lessons: 21
- [x] Sow grass seeds in remaining lawn area
- [x] Respond to estate agent
- [x] Inform Apple billing about new address

Tuesday 29 October

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern ("Zwischending: Die Psychologie des Hamsterkaufs", "Zwischending: Klatschen am Fenster", ""); Science with Sabine ("Tiny Black Holes Might Have Left Holes in... Everything"); Scott Manley ("SpaceX Secrets Leaked By Diablo Player - Deep Space Updates October 28th"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 7
- [x] Review and reactivate Honeypot.io account
- [x] Review and reactivate talent.io account

Wednesday 30 October

- [x] (Normal office day)
- [x] Next podcast or continue audio book (Coffee Break German (s2e17); The Royal Institution ("What is a white hole? - with Carlo Rovelli"); ElectroBOOM ("The MOSFET that Changes the WORLD! (ElectroBOOM101 - 012)"))
- [x] “Clozemaster” German lessons: >2000 XP
- [x] Babbel German lessons: 15

Thursday 31 October

- [x] Next podcast or continue audio book (Stand-up Maths ("How on Earth does ^.?$|^(..+?)\1+$ produce primes?"); Primitive Technology ("Tile Capped Mud Walls"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 8
- [x] Get tools from hardware store
- [x] Register as job-seeker
- [x] Begin registration as unemployed

Friday 1 November

- [x] Next podcast or continue audio book (Two Minute Papers ("NVIDIA’s New Ray Tracing Tech Should Be Impossible!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 4

Saturday 2 November

- [x] Next podcast or continue audio book (Coffee Break German (s2e18, s2e19); The Royal Institution ("Planets beyond our sun - Carl Sagan's 1977 Christmas Lectures 6/6"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 5

Sunday 3 November

- [x] Next podcast or continue audio book (Steve Mould ("Water powered timers hidden in public restrooms"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (25, "Zwischending: Kulinarische Reisen", "Zwischending: Matratzenlieferung", "Zwischending: Merkel podcastet", "Zwischending: Merkel ruft bei der Feuerwehr an", "Zwischending: Wieder im Schlafanzug", "Zwischending: Ein Mercedes im Schnee", 400); Coffee Break German (s2e20, s2e21); Scott Manley ("Why Does Blue Origin's Rocket Look Like.... You Know... ummm"); Andrej Karpathy ("Let's build GPT: from scratch, in code, spelled out." 0-1:01:58))
- [x] “Clozemaster” German lessons: >1000 XP
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (26, 27, "Zwischending: Lange nichts gehört", "Zwischending: Polizei im Zeppelin", 28); Veritasium ("On These Questions, Smarter People Do Worse"); Kurzgesagt ("The Most Insane Weapon You Never Heard About"))
- [x] “Clozemaster” German lessons: >1000 XP
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (29, "Zwischending: Öffnungsdiskussionsorgien", "Zwischending: Merkel auf mute"); Andrej Karpathy ("Let's build GPT: from scratch, in code, spelled out." 1:01:58-1:13:55))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 7
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Two Minute Papers ("New ChatGPT: Hallucinations No More!"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (30))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Download all Lohn- oder Gehaltsabrechnung

Friday 8 November

- [x] Next podcast or continue audio book (PBS Space Time ("How Can Humanity Become a Kardashev Type 1 Civilization?"); Not What You Think ("The Deadly Weapon That US Military Forgot How To Build"); The Thought Emporium ("Turning SHRIMP into Woven Fabric"); Scott Manley ("What Does Trump's Return Mean For NASA, Artemis and US Spaceflight? Deep Space Update Special...."); Two Minute Papers ("Crazy AI Learned Minecraft - Try It Out For Free!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Continue weeding around former tree
- [x] Continue filling out form for A

Saturday 9 November

- [x] Next podcast or continue audio book (Jacob Geller ("Peggle Might Be Too Pure For 2024"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern ("Zwischending: Schluss mit lustig", 40))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 11
- [x] Buy DIY parts and garden shovel
- [x] Collect un-redirected post from old apartment

Sunday 10 November

- [x] Next podcast or continue audio book (Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern ("Zwischending: Verschwörungstheorien", "Zwischending: Autos, Techno und Hupen", 41); Dr. Becky ('Is the famous black hole image "wrong"?'); 3Blue1Brown ("Why 4d geometry makes me sad"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 2
...
- [x] (Normal office day)
- [x] Next podcast or continue audio book (Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (42, 43, 44, 45, 46, 47, 48, 49); Science with Sabine ('This new "Al Scientist" can "fully automate discovery" -- and other science news of the week'))
- [x] “Clozemaster” German lessons: >2500 XP
- [x] Babbel German lessons: 42
- [x] Walk 9.4 km
...
- [x] Next podcast or continue audio book (Scott Manley ("How Britain's Air Breathing Rocket Engine Would Have Worked... If The Builder Hadn't Gone Bankrupt."); Coffee Break German (s2e22, s2e23, s2e24, s2e25, s2e26, s2e27))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 12
- [x] Walk 9.2 km
...
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Easy German ("Everyone Speaks High German, But What About Low German? | Easy German 576"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 4
- [x] Update phone lock screen
- [x] House insurance payment
- [x] Order parts for acoustics

Thursday 14 November

- [x] Next podcast or continue audio book (Coffee Break German (s2e28, s2e29); Science with Sabine ("Scientists Discover a Law of Natural Laws -- and other science news of the week"))
- [x] “Clozemaster” German lessons: >4500 XP
- [x] Babbel German lessons: 28
- [x] Collect new ID card
- [x] Anmeldung
- [x] Inform E of my new address

Friday 15 November

- [x] Next podcast or continue audio book (PBS Space Time ("Can Space Time Remember?"); Two Minute Papers ("Unreal Engine 5.5 - It Gets More Incredible!"); Robert Miles AI Safety ("Using Dangerous AI, But Safely?"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 5
- [x] Register as unemployed
- [x] Register for unemployment benefit
- [x] Find thermostat manual, correct date/time on thermostats

Saturday 16 November

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (3 items); "Soonish: Ten Emerging Technologies That Will Improve and/or Ruin Everything" (Dr. Kelly Weinersmith, Zach Weinersmith); Scott Manley ("Another Small Rocket Builder Quits The Launch Market - Deep Space Updates November 15th"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 5

Sunday 17 November

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); "Soonish: Ten Emerging Technologies That Will Improve and/or Ruin Everything" (Dr. Kelly Weinersmith, Zach Weinersmith))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 5

Monday 18 November

- [x] Next podcast or continue audio book (Science with Sabine ("New Theory: Dark Energy Might Be Black Holes -- and other science news of the week"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (58))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Write blog post: https://benwheatley.github.io/blog/2024/11/18-13.16.17.html
- [x] Update https://benwheatley.github.io/ASCII-to-Futhark-Runes-Transcription/index.html to use URL parameters as storage, enabling sharing
- [x] Draft message to builder

Tuesday 19 November

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (2 items); "Soonish: Ten Emerging Technologies That Will Improve and/or Ruin Everything" (Dr. Kelly Weinersmith, Zach Weinersmith))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 6
- [x] Message builder
- [x] Follow up issue reported by agent

Wednesday 20 November

- [x] Next podcast or continue audio book ("Soonish: Ten Emerging Technologies That Will Improve and/or Ruin Everything" (Dr. Kelly Weinersmith, Zach Weinersmith); Scott Manley ("SpaceX Fail To Repeat Booster Catch, But Starship Shows New Tricks - IFT6 Post Flight Review"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Weights: 2 kg, 50 reps each arm, 1 position

Thursday 21 November

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); "Soonish: Ten Emerging Technologies That Will Improve and/or Ruin Everything" (Dr. Kelly Weinersmith, Zach Weinersmith); "Grand Theft Astro" (Scott Meyer))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 8
- [x] Walk 15.9 km
...
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (2 items); "Grand Theft Astro" (Scott Meyer); PBS Space Time ("Is E=MC^2 Incomplete?"); Overly Sarcastic Productions ("Trope Talk: Timeloops"); Two Minute Papers ("Blender 4.3 Is Here - How Is All This Free?!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 2

Saturday 23 November

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); "Grand Theft Astro" (Scott Meyer); Plasma Channel ("This Exotic Material Holds An Invisible Secret (Electret)"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1

Sunday 24 November

- [x] Next podcast or continue audio book ("Grand Theft Astro" (Scott Meyer); Scott Manley ("Why We Must Build a Massive Gravitational Wave Telescope In Space - The LISA Mission"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 4

Monday 25 November

- [x] Next podcast or continue audio book ("Grand Theft Astro" (Scott Meyer); Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Scott Manley ("Why We Must Build a Massive Gravitational Wave Telescope In Space - The LISA Mission"); Science with Sabine ("Webb Falsified Dark Matter Prediction -- and other science news of the week"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1

Tuesday 26 November

- [x] Next podcast or continue audio book ("Grand Theft Astro" (Scott Meyer); "Time's Eye: Time Odyssey, Book 1" (Stephen Baxter, Arthur C. Clarke); Scott Manley ("How Digital Telescopes Transformed Amateur Astronomy - Making Astrophotography Easy For Everyone!"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (59))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1

Wednesday 27 November

- [x] Next podcast or continue audio book (Numberphile ("Way Bigger Than Graham's Number (Goodstein Sequence)"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 4
- [x] Deal with roof leak: move cardboard boxes, apply buckets, plastic boxes, towels; contact insurance, builder
- [x] Respond to M
- [x] Clear rubble piles

Thursday 28 November

- [x] Next podcast or continue audio book (Jordan Harrod ("Why Are AI Text Humanizers So Bad?"); History Matters ("Why did Germany declare war on America during WW2?", "Why didn't the US rename its States after independence?"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 6
- [x] Deal with roof leak: move cardboard boxes, apply buckets, plastic boxes, towels
- [x] Share wish-list
- [x] Respond to M
- [x] Activate D account

Friday 29 November

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (14 items); ElectroBOOM ("Can You Microwave Yourself?! (LATITY014)"); Scott Manley ("The Third Country To Build an Orbital Rocket - A Diamond In The Sky"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 5

Saturday 30 November

- [x] Next podcast or continue audio book (Brainiac75 ("LASER Headlamp for Cars?!? How strong is its laser? | Find out how it works and how to power it up"); The TWIML Al Podcast ("Building Al Voice Agents with Scott Stephenson"); Die Maus ("Wie funktioniert Fließbandarbeit? | Die Maus | WDR"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1

Sunday 1 December

- [x] Next podcast or continue audio book ("Time's Eye: Time Odyssey, Book 1" (Stephen Baxter, Arthur C. Clarke); Shots In The Quark ("The surprisingly large effect of your tiny gravitational pull"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 5
- [x] Assemble desk
- [x] Work on CV
...
- [x] Next podcast or continue audio book ("Time's Eye: Time Odyssey, Book 1" (Stephen Baxter, Arthur C. Clarke); Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Work on CV
- [x] Respond to E.ON
...
- [x] Next podcast or continue audio book ("Time's Eye: Time Odyssey, Book 1" (Stephen Baxter, Arthur C. Clarke); "Understanding the Misconceptions of Science" (Don Lincoln and The Great Courses))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 4
- [x] Weights: 8 kg, 5 reps each arm, 2 positions
- [x] Walk 14.4 km

Wednesday 4 December

- [x] Next podcast or continue audio book (Dream Park ("Larry Niven and Steven Barnes"); Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Science with Sabine ("We've Been Searching For Aliens All Wrong, Researchers Say -- and other science news of the week"); SpinLaunch ("Introducing The World's First Ruggedized Satellite"); Hyperspace Pirate ("Battery-Powered Magnetron"))
- [x] “Clozemaster” German lessons: >500 XP
- [x] Follow-up message to A

Thursday 5 December

- [x] Next podcast or continue audio book (Kurzgesagt ("Black Hole's Evil Twin - Gravastars Explained"))
- [x] “Clozemaster” German lessons: >1500 XP
- [x] Babbel German lessons: 6

Friday 6 December

- [x] Next podcast or continue audio book (Dream Park ("Larry Niven and Steven Barnes"); Dr. Becky ("Has JWST shown that dark matter doesn’t exist?", "WHEN did the first ever stars form in the Universe?"); PBS Space Time ("The NEW Ultimate Energy Limit of the Universe"); Dr. Becky ("Has JWST shown that dark matter doesn't exist?"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Saturday 7 December

- [x] Next podcast or continue audio book (Dream Park ("Larry Niven and Steven Barnes"); Primitive Technology ("Two Walled Tiled Hut"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Meet T & T
...
- [x] Next podcast or continue audio book (Dream Park ("Larry Niven and Steven Barnes"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Meet A
...
- [x] Next podcast or continue audio book ("The Nature of Matter: Understanding the Physical World" (David W. Ball, The Great Courses); Two Minute Papers ("NVIDIA’s New AI: Stunning Voice Generator!", "200,000 Trees Are Lit On Fire! (Simulation)", "DeepMind’s New Gaming AI Does The Impossible!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 4
- [x] Work on CV
...
- [x] Next podcast or continue audio book ("The Nature of Matter: Understanding the Physical World" (David W. Ball, The Great Courses))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 6

Wednesday 11 December

- [x] Next podcast or continue audio book ("Inherit the Stars" (James P. Hogan); Easy German ("Garden Center in Slow German | Super Easy German 267"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Apply for job
...
- [x] Next podcast or continue audio book ("Inherit the Stars" (James P. Hogan); "Black Holes, Tides, and Curved Spacetime" (Benjamin Schumacher, The Great Courses); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (50))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Walk 12.6 km
- [x] Weights: 2.5 kg, 50 reps each arm, 2 positions
...
- [x] Next podcast or continue audio book ("Black Holes, Tides, and Curved Spacetime" (Benjamin Schumacher, The Great Courses); PBS Space Time ("What Does An Electron ACTUALLY Look Like?"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 9
- [x] Walk 6.6 km
- [x] Visit DeJa Vu Museum

Saturday 14 December

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (2 items); Overly Sarcastic Productions ("History Summarized: Cyprus Breaks All The Rules", "Trope Talk: Downtime", "History Summarized: The Mitropoli - Cathedral of Marble and Memory", "Trope Talk: Realism"); OneBillionDollars ("Ilya Sutskever NeurIPS 2024 full talk"); Two Minute Papers ("Unreal Engine 5 - Ray Tracing Supercharged!", "OpenAI’s Sora Is Here, But..."))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
...
- [x] Next podcast or continue audio book ("Janissaries" (Jerry Pournelle))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Write blog post
- [x] Respond to messages from E.ON
- [x] Respond to message from recruiter
- [x] Christmas shopping: W

Tuesday 17 December

- [x] Next podcast or continue audio book ("Janissaries" (Jerry Pournelle); Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); Numberphile ("A Number to the Power of a Matrix"); MechPanda ("Building a 3D Printed Atomic-Resolution Scanning Tunneling Microscope (STM) | DIY STM Explained"); Computerphile ("A Helping Hand for LLMs (Retrieval Augmented Generation)"); S3 ("Laura Deming & Hunter Davis: A Tractable Approach to Reversible Cryopreservation"); Integza ("I built the BEST AIR ENGINE (New Rotary Design)"); Science With Sabine ("This Physics Problem is Unsolvable -- and other science news of the week", "Moore's Law is So Back -- and other science news of the week"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (51))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Wednesday 18 December

- [x] Next podcast or continue audio book ("Janissaries" (Jerry Pournelle); Numberphile ("The Anti-Parker Square"); Scott Manley ("The Toughest Space Probe Ever - How NASA Dropped A Probe Into Jupiter"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Set up 3D printer
...
- [x] Next podcast or continue audio book ("Janissaries" (Jerry Pournelle); Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (5 items); Scott Manley ("NASA Admin Is A Huge Surprise, NASA SLS Delay Is Not - Deep Space Updates"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Create headphone holder on 3D printer
- [x] Begin creating Christmas gift on 3D printer

Friday 20 December

- [x] Next podcast or continue audio book ("Janissaries" (Jerry Pournelle); Langsam gesprochene Nachrichten | Audios | DW Deutsch lernen (1 item); The TWIML Al Podcast ("Why Your RAG System Is Broken, and How to Fix It with Jason Liu"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (52))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Walk 15.0 km
- [x] Begin process of referring E.ON to Ombudsman
- [x] Finish creating Christmas gift on 3D printer
- [x] Christmas shopping: M

Saturday 21 December

- [x] Next podcast or continue audio book (PBS Space Time ("Does Infinity - Infinity = an Electron?"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 9
- [x] Christmas shopping: C

Sunday 22 December

- [x] Next podcast or continue audio book (Dr. Becky ('The mystery of JWST's "little red dots" solved?! Night Sky News December 2024'))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 2

Monday 23 December

- [x] Next podcast or continue audio book ("Janissaries" (Jerry Pournelle); Easy German ("How Has Studying Abroad Changed You?"); Easy German ("How Has Studying Abroad Changed You?"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Half-star jumps: 300
- [x] Weights: 2.5 kg, 50 reps each arm, 2 positions
- [x] Weights: 8 kg, 25 reps each arm, 2 positions
- [x] Final food shop before Xmas
- [x] Interview with W
- [x] Attempt to buy Xmas gift for R

Tuesday 24 December

- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 5
- [x] Replacement voucher for R

Wednesday 25 December

- [x] Next podcast or continue audio book (Two Minute Papers ("New Super Resolution AI - Enhance ~10x Faster!", "NVIDIA’s New AI: Training 10,000x Faster!"); Scott Manley ("Forgotten Soviet Rockets - Did Ukraine Designers Make The Best Soviet Rockets?"); ElectroBOOM ("Making a High Voltage Fuse"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Prepare Christmas lunch

Thursday 26 December

- [x] Next podcast or continue audio book ("A Stitch in Time / Star Trek: Deep Space Nine" (Andrew J. Robinson); 3Blue1Brown ("This open problem taught me what topology is"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (53))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
- [x] Visit S
...
- [x] Next podcast or continue audio book ("A Stitch in Time / Star Trek: Deep Space Nine" (Andrew J. Robinson); Veritasium ("This Musical Instrument Took Eons To Make"); Steve Mould ('The "Impossible Torpedo" was real'))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Saturday 28 December

- [x] Next podcast or continue audio book ("A Stitch in Time / Star Trek: Deep Space Nine" (Andrew J. Robinson); OpenAI ("OpenAI o3 and o3-mini—12 Days of OpenAI: Day 12"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Sunday 29 December

- [x] Next podcast or continue audio book (Two Minute Papers ("NVIDIA’s New AI: A Revolution In 3D Modeling!"); Scott Manley ("Elon Musk's Abandoned Plan To Grow Plants On Mars - Mars Oasis"); History Matters ("Why didn't Poland hand over Danzig to Germany?"); rewboss ("This border is completely pointless"); CodeParade ("Did I Just Solve An Unsolved Math Problem?"); Overly Sarcastic Productions ("History-Makers: Augustine of Hippo Gets Dragged Into Sainthood", "Legends Summarized: Journey To The West (Part XII)"); The TWIML Al Podcast ("Why Agents Are Stupid & What We Can Do About It with Dan Jeffries"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3

Monday 30 December

- [x] Next podcast or continue audio book ("A Stitch in Time / Star Trek: Deep Space Nine" (Andrew J. Robinson); OpenAI ("Work with Apps—12 Days of OpenAI: Day 11"); Easy German: Learn German with native speakers | Deutsch lernen mit Muttersprachlern (54, 55))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 3
