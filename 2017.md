...
- [x] Apply for this job: «Redacted Glassdoor.co.uk link»
- [x] Apply for one other job
- [x] iOS skills summary
- [x] Contact Mike about Spain
- [x] Sign and return Spain contract
- [x] Next podcast or audio book
- [x] GLSL shader version of hyperspace (hacked together, needs cleanup)
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] Read and close some browser tabs (9)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
- [x] Duolingo Greek
...
- [x] Finish GLSL shader version of hyperspace
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
...
- [x] Make Procedural Hyperspace video, [upload to YouTube](https://www.youtube.com/watch?v=mQGXVSG1p_Q)
- [x] Next podcast or audio book
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
...
- [x] Contact domain name registrar about WHOIS postal address
- [x] Add hackerrank.com and shadertoy.com links to my home page
- [x] Time machine backup
- [x] Respond to Kaus email
- [x] Respond to Cathy email
- [x] Email Student Loans company about a) broken login system to update address, b) why they never explained why they sent post to «Redacted childhood address» 9 years after I left
- [x] Buy Cathy xmas gift
- [x] Update financial spreadsheet
- [x] Next podcast or audio book
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
...
- [x] Go to game developer post-hackathon demonstration event
- [x] Next podcast or audio book
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
...
- [x] Watch Royal Institute lecture on YouTube
- [x] Next podcast or audio book
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
...
- [x] Next podcast or audio book
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] Read and close some browser tabs (0)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
- [x] Duolingo Greek
...
- [x] Plan Cambridge pre-xmas
- [x] Respond to Dave
- [x] Book interview
- [x] Continue research: Independent Financial Advisors for Mike
- [x] Next podcast or audio book
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] Read and close some browser tabs (3)
- [x] "Clozemaster" German lesson
...
- [x] Help Mike look for IFAs
- [x] Ask about OSM overlay of ABC zones in Berlin (Answer: [no](https://gis.stackexchange.com/questions/265509/openstreetmap-public-transport-zones))
- [x] Next podcast or audio book
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] Read and close some browser tabs (1)
- [x] "Clozemaster" German lesson
...
- [x] Online check-in (double-check bag sizes, packing)
- [x] Buy Wendy birthday Amazon gift voucher (and all Xmas vouchers)
- [x] Reply to Richard
- [x] Get down to 30 unread emails
- [x] Next podcast or audio book
- [x] Work through more of the downloaded Swift lectures
- [x] Complete any one tutorial from my to-do list (hackerrank.com)
- [x] Read and close some browser tabs (9)
...
- [x] Pack
- [x] [Walk from Berlin city center to Schönefeld Airport](https://my.viewranger.com/track/details/NjQ2MTY2Mw==)
- [x] Flight to UK
- [x] If taxi shuttle bus is good enough, book car rental; else will get taxi
- [x] Meet Carlton Arms set friends for curry in Cambridge
- [x] Next podcast or audio book
- [x] Read and close some browser tabs (2)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
...
- [x] Reply to «Redacted» challenge schedule request
- [x] Get xmas cards for Cambridge people
- [x] Reduce 3 monthly bandwidth to 12 GB to save money
- [x] Meet Furry Cambridge friends for pizza and film
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
...
- [x] Help family deal with Mum's dementia
- [x] Get down to 40 unread emails
- [x] Tell SAB about new address (Waterlooville)
- [x] Contact bank about broken app
- [x] Read and close some browser tabs (1)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
...
- [x] Ask about code challenge
- [x] Read through code challenge task, see what the code looks like, and think about it
- [x] See if code challenge code works
- [x] Respond to possible HackerNews job offer
- [x] Shop for things to help Mike
- [x] Next podcast or audio book
- [x] Read and close some browser tabs (1)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
...
- [x] Read through code challenge task
- [x] Plan code challenge
- [x] Help out with Mum's dementia
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
- [x] Duolingo Greek
...
- [x] Do as much of code challenge as I have time for
- [x] Set up calendar reminder for Mike to pay money to Spanish people
- [x] Final xmas shopping
- [x] Xmas cards
- [x] Get down to 35 unread emails
- [x] Plan xmas Sadie travel more, see notes in Hangouts
- [x] Buy and print Eurostar tickets
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
- [x] Duolingo Greek
...
- [x] Xmas
- [x] Finish code challenge
- [x] Email solution to code challenge
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
- [x] Duolingo Greek
...
- [x] Collect Sadie from airport
- [x] Search for lost paperwork
- [x] Help look after Mum
- [x] Next podcast or audio book
...
- [x] Plan/set reminders for train to St Pancras
- [x] Next podcast or audio book
- [x] Complete any one tutorial from my to-do list (hackerrank.com or hackerearth.com)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
- [x] Duolingo Greek
- [x] (150) star jumps with 1kg weights in each hand
- [x] (20) push-ups
...
- [x] Pack
- [x] Move bike to loft
- [x] Get to London in time for Eurostar
- [x] Get to Paris, meet Lili
- [x] Read and close some browser tabs (1)
- [x] "Clozemaster" German lesson
- [x] Duolingo German
- [x] Duolingo Esperanto
