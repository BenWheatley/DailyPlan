...
- [x] Shop for alternative xmas gift for A because order not delivered
- [x] (Normal office day)
...
- [x] Next podcast or continue audio book ("The Canterbury Tales" (Geoffrey Chaucer); Tomorrow's Build ("A Swarm of Robots Built This Tunnel"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Duolingo German: 1 standard practice
- [x] Brilliant.org lessons: 1
...
- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Deutsch lernen | Deutsche Welle (1 item); "The Canterbury Tales" (Geoffrey Chaucer); Stand-up Maths ("Once a Millennium Alignment of All Three Norths"); Scott Manley ("Can You Cook a Turkey by Dropping It From Space?"); The Bayesian Conspiracy (first half of 177); Isaac Arthur ("Do We Live Inside A Black Hole... And Could We?"))
- [x] Continue editing novel
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Duolingo German: 4 standard practice
- [x] Brilliant.org lessons: 1
- [x] Walk 5.8 km

Saturday 31 December

- [x] Next podcast or continue audio book (Langsam gesprochene Nachrichten | Deutsch lernen | Deutsche Welle (1 item); Two Minute Papers ("NVIDIA’s New AI: Paint With Your Words!"))
- [x] “Clozemaster” German lessons: >1000 XP
- [x] Babbel German lessons: 1
- [x] Duolingo German: 1 standard practice
- [x] Brilliant.org lessons: 1
